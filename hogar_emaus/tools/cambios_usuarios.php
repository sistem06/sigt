...
if (!empty($_GET['us_id'])){
  ...
  $txt_p_us_tipo = "select * from tb_usuarios_sistemas where (uss_us_id = '".$_GET['us_id']."' and uss_sistema = '5')";
  $p_us_tipo = mysql_fetch_array(mysql_query($txt_p_us_tipo));
  $valor = $p_us_tipo['uss_tipo'];
...
<input type="hidden" name="sistema" value="5" />

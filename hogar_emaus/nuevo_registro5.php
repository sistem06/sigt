...
<?php echo SelectGeneral("nro_org", "form-control", "org", "Entidad Otorgante:", "tb_organizaciones", "or_id", "or_name"); ?>
<div class="requerido" id="falta_org">Falta completar este campo</div>
</div>

<div class="checkbox">
  <label>
    <input name="vigente" type="checkbox" value="SI">
    Esta Vigente el Crédito?
  </label>
</div>

<div class="form-group">
<?php echo SelectGeneral("nro_destino", "form-control", "destino", "Destino del Crédito:", "tb_motivo_credito", "mc_id", "mc_name"); ?>
...
?>
<tr><td><?php echo utf8_encode($lis_dat['or_name']); ?></td><td><?php echo utf8_encode($lis_dat['mc_name']); ?></td><td><a href="quitar.php?val=<?php echo $lis_dat['ec_id']; ?>&id=ec_id&tabla=tb_emprendedor_credito"  title="eliminar" class="fancybox fancybox.iframe"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
</tr>
<?php
}
?>
</table>
<a href="nuevo_registro6.php?dp_id=<?php echo $_GET['dp_id']; ?>&em_id=<?php echo $_GET['em_id']; ?>" title="continuar">

    ...
    <ul class="nav navbar-nav">
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="../hogar_emaus/beneficiarios.php">Beneficiarios</a></li>
            <li><a href="../hogar_emaus/nuevo_registro.php">Nuevo Beneficiario</a></li>
...
<!-- agregar en otros -->
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="../hogar_emaus/beneficiarios.php">Emprendedores</a></li>

            <li class="divider"></li>
            <li><a href="../hogar_emaus/organizaciones.php">Organizaciones</a></li>

...
</td><td><a href="quitar.php?val=<?php echo $lis_dat['fam_id']; ?>&id=fam_id&tabla=tb_familiares"  title="eliminar" class="fancybox fancybox.iframe"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
</tr>
<?php
}
?>

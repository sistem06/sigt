<?php
	...
	if($_POST['tabla']=="tb_usuarios"){
		if($_POST['accion']=="A"){
			...
			$user = new Usuario();
			$user->us_nombre = $_POST['nombre'];
			$user->us_apellido = $_POST['apellido'];
			...
			$user->us_observaciones = $_POST['observaciones'];
			$user->save();
	...
	if($_POST['tabla']=="tb_puestos"){
		if($_POST['accion']=="A"){
			...
			$texto = "Se modifico el puesto exitosamente";
	...
	if($_POST['tabla']=="tb_cursos_externos"){
		if($_POST['accion']=="A"){
			...
			$feri->ce_ciudad = $_POST['ce_ciudad'];
			$feri->save();
		} else {

...
<div class="paso_in"> Datos Laborales de
...
?>
<tr><td><?php echo BuscaRegistro ("tb_tipo_trabajo", "tt_id", $lis_dat['al_tipo_trabajo'], "tt_name"); ?></td>
	<td><?php echo fecha_dev($lis_dat['al_in']); ?></td>
	<td><?php if($lis_dat['al_actual'] != 1){ echo fecha_dev($lis_dat['al_out']);} ?></td>
	<td><?php echo $lis_dat['al_lugar_trabajo']; ?></td>
	<td><?php echo BuscaRegistro ("tb_puestos", "pu_id", $lis_dat['al_puesto'], "pu_name"); ?></td>
	<td><a href="tools/cambios_antecedentes.php?al_id=<?php echo $lis_dat['al_id']; ?>&dp_id=<?php echo $_GET['dp_id']; ?>"  title="modificar" class="fancybox fancybox.iframe" id="modifica_dato">
		<button type="button" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></button></a></td>
...
<input type="hidden" name="paso" value="70">

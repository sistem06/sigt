...
<body>
    ...
    <?php
if (!empty($_GET['mc_id'])){
  $titulo = "Modificar Motivo de Credito";
  ...
  $titulo = "Nueva Motivo de Credito";
  $titulo_boton = "Guardar";
  $us_form = InputGeneral("text", "mc_name", "form-control", "usuario", "describa el motivo", "Motivo de Credito:");
  $accion = "A";
}
  ?>
  <div class="container">
...
<input type="hidden" name="tabla" value="tb_motivo_credito" />
</form>
</div>

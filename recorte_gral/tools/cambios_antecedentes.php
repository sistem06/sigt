...
<div class="col-xs-12 col-md-4">
 ...
 <div id="listado_puestos" display="none"></div>
  ...
  <a href="cambios_puestos.php"  id="agrega_puesto" class="fancybox fancybox.iframe" style="display:none;">nueva carrera</a>
  <div class="col-xs-12 col-md-4">
        <div class="form-group  has-success">
  ...
  <a href="cambios_categorias.php"  id="agrega_categoria" class="fancybox fancybox.iframe" style="display:none;">nueva carrera</a>

  <a href="cambios_actividades.php"  id="agrega_actividad" class="fancybox fancybox.iframe" style="display:none;">nueva carrera</a>
</div>

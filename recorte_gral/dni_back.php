...
<?php
  $txt_ar = "select * from tb_imagenes where (img_dp_id = '".$_GET['dp_id']."' and img_front='0')";
  $query_ar = mysql_query($txt_ar);
  $n_ar = mysql_num_rows($query_ar);
  if ($n_ar==0){
?>
  <form id="parte1" action="tools/add_archivo1.php" method="post" role="form" enctype="multipart/form-data" style="padding:10px;">

  <div class="form-group">
  <label class="control-label">Seleccione la imagen de la PARTE TRASERA del DNI:</label>
                ...
                <input type="hidden" name="img_front" value="0">
...
<img src="../imagenes/dni1_th_<?php echo $_GET['dp_id']; ?>.jpg">
<br><br>
<a href="tools/quitar.php?val=<?php echo $_GET['dp_id']; ?>&id=img_id&tabla=tb_imagenes&img=back"  title="eliminar" class="fancybox fancybox.iframe"><button class="btn btn-danger">Quitar</button></a>
</div>
<br clear="all">
<?php
}

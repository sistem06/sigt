...
<?php include("../recorte_gral/datos_personales_gral.php"); ?>
  ...
  <span class="glyphicon glyphicon-star"></span>  Otros datos</div>
    ...
    <div class="col-xs-12 col-md-6">
      <div class="form-group">
          ...
          <div class="radio">
        <label>
          <input type="radio" name="dp_fam_vetenaro" id="dp_fam_vetenaro1" value="1">
          Si
        </label>
      </div>
      <div class="radio">
        <label>
          <input type="radio" name="dp_fam_vetenaro" id="dp_fam_vetenaro2" value="0" checked>
          No
        </label>
      </div>
  </div>

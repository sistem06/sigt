...
$dp_id = $_POST['dp_id'];
	...
	$foto_name = "dni1_".$dp_id.".jpg";
	$fileDest	= "../../imagenes/dni1_".$dp_id.".jpg";
	if ($_FILES ['archivo']['error'] == 0){
		...
		$destinoch =  "../../imagenes/dni1_th_".$dp_id.".jpg";
...
mysql_query("insert into tb_imagenes (img_dp_id,img_dni_name,img_front) values ('$dp_id','$foto_name','$img_front')");
		...
		chmod($destinoch, 644);
if($_POST['estado']=="E"){
	header("Location: ../nuevo_archivos1.php?dp_id=$dp_id&estado=E");
} else{
	header("Location: ../nuevo_archivos1.php?dp_id=$dp_id");
}

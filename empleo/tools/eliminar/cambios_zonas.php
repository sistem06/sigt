...
if (!empty($_GET['zo_id'])){
 ...
 /* $valor = BuscaRegistro ("tb_usuarios", "us_id", $_GET['us_id'], "us_tipo");
  ...
  $titulo = "Nueva Zona de Comercializacion";
  $titulo_boton = "Guardar";
  $us_form = InputGeneral("text", "zo_name", "form-control", "usuario", "nombre de la zona", "Nombre de la Zona:");
...
<input type="hidden" name="tabla" value="tb_zonas" />
</form>
</div>

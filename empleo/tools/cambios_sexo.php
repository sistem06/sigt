...
if (!empty($_GET['zo_id'])){
 ...
 /* $valor = BuscaRegistro ("tb_usuarios", "us_id", $_GET['us_id'], "us_tipo");
  ...
  $titulo = "Nuevo Género Autopercibido";
  $titulo_boton = "Guardar";
  $us_form = InputGeneral("text", "sx_name", "form-control", "usuario", "nuevo genero Autopercibido", "Nombre del Género:");
...
<input type="hidden" name="sx_id" value="<?php echo $_GET['sx_id']; ?>" />

<input type="hidden" name="accion" value="<?php echo $accion; ?>" />

<input type="hidden" name="tabla" value="tb_sexos" />
</form>
</div>

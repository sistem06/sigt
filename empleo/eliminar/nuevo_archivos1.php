...
<br><br>
<a href="tools/quitar.php?val=<?php echo $_GET['dp_id']; ?>&id=img_id&tabla=tb_imagenes"  title="eliminar" class="fancybox fancybox.iframe"><button class="btn btn-danger">Quitar</button></a>
</div>
<br clear="all">
<?php
}

...
?>
<tr><td><?php echo BuscaRegistro ("tb_nivel_educativo", "ne_id", $lis_dat['dne_nivel'], "ne_name"); ?></td><td><?php echo BuscaRegistro ("tb_estado_titulo", "et_id", $lis_dat['dne_termino'], "et_name"); ?></td><td><?php echo BuscaRegistro ("tb_modalidad_cursado", "mc_id", $lis_dat['dne_modalidad'], "mc_name"); ?></td><td><?php echo BuscaRegistro ("tb_titulo_secundario", "ts_id", $lis_dat['dne_titulo'], "ts_name"); ?></td><td><a href="tools/quitar.php?val=<?php echo $lis_dat['dne_id']; ?>&id=dne_id&tabla=tb_datos_nivel_educativo"  title="eliminar" class="fancybox fancybox.iframe" id="quita_titulo"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a></td>
</tr>
<?php
}
?>
    ...
    <span class="glyphicon glyphicon-credit-card"></span>  Permisos / Licencias / Matriculas 
      ...
      <button type="button" class="btn btn-warning" id="muestra_licencias"><span class="glyphicon glyphicon-plus"></span>Agregar</button>
       ...
       <div id="cursos_licencias" style="background: #E0F0F4; padding: 10px; display: none;">
             <form id="parte11" action="tools/add_registro.php" method="post" role="form">
                <div class="row">
  ...
  /*    $("#envia1").mouseover(function(){
         ...
         $.post("tools/titulos1.php",{nivel: $("#denivel").val(), titulo: $("#titulogral").val()},function(result){
                  if(result == 0){
                    ...
                    $("#listado_titulos").text("no ha elegido un elemento de la lista");
...
/*  $("#envia3").click(function() {
      if($("#cursoexterno").val()==""){
      $("#falta_nombre_cursoex").show();
      return false;
    }
  }); */
